...
app.use("/image", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, filename, width, height, file, outPut, requetWidth, requetHidth, fileToRead, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.sent();
                if (filename) {
                    fileToRead = path.join(__dirname + "/public/index.html");
                    (0, utils_1.readFiles)(res, fileToRead, filename);
                }
                else {
